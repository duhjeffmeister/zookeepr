...
const handleAnimalFormSubmit = event => {
  ...
  // Sends data from the front end to the back end to be POST-ed.
  fetch('/api/animals', {
    // Allows the request to make it to the proper endpoint in the server
    method: 'POST',

    // Tells the request what type of data to look for.
    headers: {
